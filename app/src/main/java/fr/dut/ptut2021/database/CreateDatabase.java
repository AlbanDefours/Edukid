...
@Database(entities = { User.class, Theme.class, Game.class, ThemeGameCrossRef.class, GameLog.class, WordWithHoleData.class, PlayWithSoundData.class, DrawOnItData.class}, version = 6, exportSchema = false)
